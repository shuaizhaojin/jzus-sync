...
\begin{figure}[t]
   ...
   \begin{subfigure}
       \centering
       \includegraphics[scale=0.55]{graphs/tourist-climate/th1}
   \end{subfigure}
   \begin{subfigure}
       \centering
       \includegraphics[scale=0.55]{graphs/tourist-climate/h1}
   \end{subfigure}
   \begin{subfigure}
       \centering
       \includegraphics[scale=0.55]{graphs/tourist-climate/co2}
   \end{subfigure}
   \begin{subfigure}
       \centering
