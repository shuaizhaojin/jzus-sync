...
\begin{table}[t]
  ...
  \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|}\hline
      Node & $S_1$ & $S_2$ & $S_3$ & $S_4$ & $S_5$ & $S_6$ & $S_7$ & $S_8$ & $S_9$ & $S_{10}$ \\ \hline
	  $S_1$   & 0  & 8  & 2  & 2  & 2  & 2  & 4  & 5  & 2  & 0   \\ \hline
	  $S_2$   & 5  & 0  & 3  & 4  & 3  & 3  & 2  & 7  & 3  & 0   \\ \hline
	  $S_3$   & 5  & 3  & 0  & 2  & 3  & 5  & 0  & 3  & 2  & 4   \\ \hline
	  $S_4$   & 4  & 4  & 4  & 0  & 3  & 1  & 2  & 4  & 4  & 4   \\ \hline
	  $S_5$   & 2  & 2  & 2  & 3  & 0  & 4  & 2  & 5  & 2  & 3   \\ \hline
	  $S_6$   & 1  & 3  & 6  & 5  & 2  & 0  & 3  & 4  & 4  & 2   \\ \hline
	  $S_7$   & 2  & 2  & 1  & 2  & 2  & 3  & 0  & 7  & 4  & 2   \\ \hline
	  $S_8$   & 2  & 3  & 2  & 2  & 8  & 5  & 2  & 0  & 2  & 2   \\ \hline
	  $S_9$   & 2  & 4  & 4  & 5  & 1  & 4  & 3  & 2  & 0  & 2   \\ \hline
      $S_{10}$  & 1  & 2  & 1  & 3  & 2  & 2  & 3  & 5  & 3  & 0   \\ \hline
  \end{tabular}}
  %\figurespace
\end{table}
...
distribution in each cave. Table~\ref{tab:movingtrace} shows the produced moving trace 
of three days. For an element at row $S_X$ and column $S_Y$, the value refers to the
number of times when mobile nodes travel from room $S_X$ to room $S_Y$.
For example, $[S_2, S_3] = 3$ means that mobile nodes have traveled from room $S_2$
to room $S_3$ for 3 times totally in the trace.
