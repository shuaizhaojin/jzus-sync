...
%        \centering
%        \includegraphics[scale=0.42]{figs/searchlight}
%        \caption{Searchlight-S}
%        \label{fig:searchlight}
%   \end{subfigure}\hfill
%   \begin{subfigure}[t]{0.3\columnwidth}
%        \centering
%	\includegraphics[scale=0.42]{figs/searchlight+1}
%	\caption{Searchlight-S+1}
%	\label{fig:searchlight+1}
%   \end{subfigure}\hfill
%   \begin{subfigure}[t]{0.3\columnwidth}
%        \centering
%        \includegraphics[scale=0.42]{figs/searchlight-1}
%        \caption{Searchlight-S+1/2}
...
%        \includegraphics{graphs/one-month-result/august-25ms-5-orig}
...
%	\includegraphics{graphs/one-month-result/august-25ms-1-orig}
...
%        \includegraphics{graphs/one-month-result/cdf_august_duration}
...
%        \includegraphics{graphs/one-month-result/august-5ms-1-orig}
...
%        \includegraphics{graphs/one-month-result/august-5ms-1-dcs}
%        \caption{With DCS.}
...
%        \includegraphics{graphs/one-month-result/august-5ms-1-syn}
%        \caption{With MASS.}
...
synchronized. The worst-case latency, however, remained the same,
likely because either some nodes could not be synchronized such as
cave 12 and 29, or they had to be re-synchronized at the start of each
day.
...
%   \centering
%   \vspace{0pt}
%   \includegraphics{graphs/one-month-result/august-low-syn}
...
%   \centering
%   \vspace{0pt} 
%   \includegraphics{graphs/one-month-result/august-5ms-1-anc-searchlight-strip}
...
%   \includegraphics{graphs/one-month-result/august-random-5ms-1}
