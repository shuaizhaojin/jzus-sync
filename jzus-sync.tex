...
the experiments on the third floor of a building.
We used 10 rooms to simulate 10 caves and put one static node in each room. Then we invite 
...
are totally 300 discovery records. For comparison, the volunteers carry 
